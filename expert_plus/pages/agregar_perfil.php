                                ...
                                <div class="card card-flush">  
                                    <div class="card-header"> 
                                        <div class="card-toolbar">
                                            <button type="submit" class="btn btn-light-primary"><i class="las la-save"></i>Guardar</button>
                                        </div>
                                    </div>    
                                </div>                                                                                
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">
                                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="checkbox" <?php echo $chkEstado; ?> id="chk<?php echo $perfil['MentId']; ?>" <?php if ($perfil['Estado'] == 'Activo') {
                                                                    echo "checked";} else {'';} ?> value="<?php echo $perfil['MentId']; ?>" />
                                                            </div>
                                                        </td>                                                                      
