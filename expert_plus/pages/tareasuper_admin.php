		...
		<script>
			$(document).ready(function(){
				...
				$(document).on("click",".btnEditar",function(){
					...
					// $.post("codephp/editar_tarea.php", $parametros , function(data){
                    
					// 	var _datavalues = JSON.parse(data);
					// 	var _tarea = _datavalues[0];
					// 	var _ruta = _datavalues[1];
                	// });					
				...
				$('#btnSave').click(function(e){
					...
					var _usuacodigo = "<?php echo $yUsuaCodigo; ?>"
