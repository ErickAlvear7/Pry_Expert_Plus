<?php 
    ...
    $xSQL .= "ELSE 'Inactivo' END AS Estado FROM expert_tarea WHERE empr_id=$xEmprid AND tare_superadmin=0 ORDER BY tare_orden " ;
                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">  
                        ...
                        <div class="card-toolbar">
                            <button type="button" name="guardar" class="btn btn-primary" onclick="f_Guardar(<?php echo $xEmprid; ?>,<?php echo $xUsuaid; ?>)"><i class="las la-save"></i>Grabar</button>
                        </div>  
                    </div>
                        ...
                        <thead>
                             ...
                             <tbody class="fw-bold text-gray-600">
                                <?php foreach($all_menu as $submenu){
                                    ...
                                    ?>
                                <tr id="tr_<?php echo $xIdSub; ?>">
                                    
                                    <td style="display:none;"><?php echo $xIdSub; ?></td>
                                    <td style="text-align: center;" >
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input chkSubMenu" name="chkSubMenu" id="chk<?php echo $xIdSub; ?>" type="checkbox" value="<?php echo $xIdSub; ?>" />
                                        </div>
                                    </td>
                                    
                                    <td>
                                        <div id="div_<?php echo $xIdSub; ?>" >
