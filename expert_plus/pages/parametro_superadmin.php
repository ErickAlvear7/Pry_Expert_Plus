<?php
    ...
    $xSQL .= "FROM `expert_superparametro_cabecera`";
                            ...
                            <div class="text-center">
								<div class="form-check form-check-sm form-check-custom form-check-solid">
									<input <?php echo $xCheking; ?> class="form-check-input h-20px w-20px border-primary btnEstado" type="checkbox" id="chk<?php echo $xPacaId; ?>" 
                                       onchange="f_UpdateEstado(<?php echo $xPacaId;?>)" value="<?php echo $xPacaId;?>"/>
								</div>
							</div>
						</td>
						<td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body py-10 px-lg-17">
        ...
        <div class="modal-footer">
            ...
            <button type="button" id="btnGuardar" onclick="f_Guardar(<?php echo $xUsuaid; ?>)" class="btn btn-primary">Grabar</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
   ...
   var _estado, _detalle,_valorI,_result = [],_count =0,_idusua;
  ...
  //Agregar detalle del paametro
   ...
   //Guardar parametro-detalle
    ...
    function f_UpdateEstado(_pacaid){
