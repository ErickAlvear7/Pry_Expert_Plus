    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                ...
                <button type="button" id="btnRegresar" onclick="f_Regresar(<?php echo $xClieid; ?>,<?php echo $xTituid; ?>,<?php echo $xProdid; ?>,<?php echo $xGrupid; ?>)" class="btn btn-icon btn-light-primary btn-sm ms-auto me-lg-n7" title="Regresar" data-bs-toggle="tooltip" data-bs-placement="left">
...
<script>
    ...
    //Regresar Pagina
    function f_Regresar(_clieid,_tituid,_prodid,_grupid){

        $.redirect('?page=adminagenda&menuid=<?php echo $menuid; ?>', {
            'clieid': _clieid,
            'tituid': _tituid,
            'prodid': _prodid,
            'grupid': _grupid,
