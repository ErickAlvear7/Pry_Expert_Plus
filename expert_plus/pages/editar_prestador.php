    ...
    <div id="formPresta" class="form d-flex flex-column flex-lg-row">
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-n2">
                ...
                <a href="?page=prestador_admin&menuid=<?php echo $menuid;?>" class="btn btn-icon btn-light-primary btn-sm ms-auto me-lg-n7" title="Regresar" data-bs-toggle="tooltip" data-bs-placement="right">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="tab-content">
                                    ...
                                    <div id="kt_customer_view_payment_method_2" class="collapse fs-6 ps-10" data-bs-parent="#kt_customer_view_payment_method">
                                        <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-3 row-cols-lg-3">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control mb-2 w-150px" name="txtFono2" id="txtFono2" maxlength="9" placeholder="022222222" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" value="<?php echo $xFono2; ?>" />
                                            </div> 
                                            <div class="col">
                                                <div class="fs-6 fw-bold mt-2 mb-3">Telefono 2:</div>
                                                <input type="text" class="form-control mb-2 w-150px" name="txtFono2" id="txtFono2" maxlength="9" placeholder="022222222" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" value="<?php echo $xFono3; ?>" />
                                            </div>                                                        
                                        </div>
                                        <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-3 row-cols-lg-3">
                                            <div class="col">
                ...
                <div class="tab-pane fade" id="kt_ecommerce_add_product_advanced" role="tab-panel">
                    <div class="d-flex flex-stack fs-4 py-3">
                        <div class="fw-bolder rotate collapsible btn btn-sm btn-light-primary" data-bs-toggle="collapse" href="#kt_user_view_especialidad" role="button" aria-expanded="false" aria-controls="kt_user_view_details">Agregar Especialidad
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        <div id="kt_user_view_especialidad" class="collapse">
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title">
                            ...
                            <div class="card-body pt-0" id="kt_contacts_list_body">
                                <div class="d-flex flex-column gap-10">
                                    <div class="scroll-y me-n7 pe-7" id="parametro_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#parametro_header" data-kt-scroll-wrappers="#parametro_scroll" data-kt-scroll-offset="300px">
                                        <table id="tblEspecialidad" class="table table-hover align-middle table-row-dashed fs-6 gy-5" style="width: 100%;">
                                            <thead>
                                ...
                                <div id="telefono_profesional" class="collapse fs-6 ps-10" data-bs-parent="#datos_profesional">
                                    <div class="row row-cols-2 row-cols-sm-2 rol-cols-md-2 row-cols-lg-2">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control mb-3 w-150px" name="txtFonoProf" id="txtFonoProf" maxlength="9" placeholder="0299999999" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" />
                                        </div>
                                        <div class="col">
...
<script>
    $(document).ready(function(){
        ...
        $('#btnSaveNew').click(function(e){
            ...
            if(_cbotipoespe == '0'){
                mensajesalertify('Seleccion Tipo Especialidad', 'W', 'top-right', 3);
                return;
            }

            if(_especialidad == ''){
                mensajesalertify('Ingrese Especialidad', 'W', 'top-right', 3);
                return;
            }
        ...
        $('#btnAgregar').click(function(e){
            ...
            xrespuesta.done(function(response){
                ...
                if(response != 0){
                    ...
                    _output += '<td><div class="ms-3"><span class="fw-bolder">' + _especialidad + '</span><input type="hidden" id="txtEspecialidad' + _id + 'value="' + _especialidad +  '" /></div></td>';
                    _output += '<td><span class="fw-bolder">' + _pvp + '</span></td>';
                    _output += '<td><span class="fw-bolder">' + _costo + '</span></td>';
                    ...
                    _output += 'title="Editar Especialidad Asiganada" data-bs-toggle="tooltip" data-bs-placement="left" ><i class="fa fa-edit"></i></button>';
                    _output += '<button id="btnPerson_' + _id + '" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" ';
                    _output += 'title="Agregar Profesional" data-bs-toggle="tooltip" data-bs-placement="left" ><i class="fa fa-user"></i></button></div></div></td></tr>';
        ...
        $('#btnAgregarTipo').click(function(e){
            ...
            if(_tipoprofesion == ''){
                mensajesalertify('Ingrese Tipo Profesion..!', 'W', 'top-right', 5);
                return;
            }

            if(_valcodigoprof == ''){
                mensajesalertify('Ingrese Valor/Codigo Tipo Profesion..!', 'W', 'top-right', 5);
                return;
            }
            ...
            if(_continuar){
                ...
                xrespuesta.done(function(response){
                    ...
                    if(_padeid > 0){
                        ...
                        mensajesalertify('Tipo Profesion ya existe.!', 'W', 'top-right', 5);                            
                    }
        ...
        $('#btnSave').click(function(e){
           ...
           if(_prestador == ''){
               mensajesalertify("Ingrese Nombre del Prestador..!", "W", "top-right", 3);
               return;                         
           }

           if(_sector == ''){
               mensajesalertify("Seleccione Sector..!", "W", "top-right", 3);
               return; 
           }
           
           if(_tipopresta == ''){
               mensajesalertify("Seleccione Tipo Prestador..!", "W", "top-right", 3);
               return; 
           }                       
           ...
           if(_email1 != ''){
               ...
               if (regex.test($('#txtEmail1').val().trim())) {
                   ...
                   mensajesalertify("Email1 no es Valido..!", "W", "top-right", 3);
                   return;
               }
           }
           ...
           if(_email2 != ''){
               ...
               if (regex.test($('#txtEmail2').val().trim())) {
                   ...
                   mensajesalertify("Email2 no es Valido..!", "W", "top-right", 3);
                   return;
               }
           }
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response == 'OK'){
                        ...
                        mensajesalertify("Prestador ya Existe..!", "W", "top-right", 3);
                    }
                },
    ...
    function f_DelAsigProf(_paisid, _emprid, _pfesid){
        ...
        var xrespuesta = $.post("codephp/consultar_horarioprofesional.php", _parametros);
            ...
            if(response.trim() == 'OK'){
                ...
                mensajesalertify("El registro tiene horarios configurados..!", "W", "top-right", 3);
            }
        });
    }
    ...
    function f_DelHorario(_paisid, _emprid, _horaid){
        ...
        var xrespuesta = $.post("codephp/del_horarioprofesional.php", _parametros);
            ...
            if(response.trim() == 'OK'){
                ...
                mensajesalertify("Hubo algun error, no se puedo eliminar..!", "W", "top-right", 5);
            }
        });
    }            
    ...
    $('#btnAgregarHorario').click(function(e){
        ...
        if(_dia == ''){
            mensajesalertify("Seleccione Dia..!", "W", "top-right", 5);
            return;
        }
        ...
        if(_horadesde == ''){
            mensajesalertify("Seleccion Hora Inicio..!", "W", "top-right", 5);
            return;
        }

        if(_horahasta == ''){
            mensajesalertify("Seleccione Hora Final..!", "W", "top-right", 5);
            return;
        }                
        ...
        if (minutos_final < minutos_inicio){
            mensajesalertify("La Hora Inicio no puede ser mayor a la Hora Final..!", "W", "top-right", 5);
            return;
        } 
        ...
        if(parseInt(_intervalo) >= diferencia){
            mensajesalertify("La diferencia del Intervalo es menor o igual a la horas establecidas..!", "W", "top-right", 5);
            return;
        }
    ...
    $('#btnSaveProf').click(function(e){
        ...
        if(_tipodoc == ''){
            mensajesalertify("Seleccione Tipo Documento..!", "W", "top-right", 5);
			return;                    
        }

        if(_numdocumento == ''){
            mensajesalertify("Ingrese Numero de Documento..!", "W", "top-right", 5);
			return;                    
        }

        if(_nombres == ''){
            mensajesalertify("Ingrese Nombres..!", "W", "top-right", 5);
			return;                    
        }

        if(_genero == ''){
            mensajesalertify("Seleccione Tipo Genero..!", "W", "top-right", 5);
			return;                    
        }

        if(_tipoprof == ''){
            mensajesalertify("Seleccione Tipo Profesion..!", "W", "top-right", 5);
			return;                    
        }                 
        ...
        if(_emailprof.trim() != ''){
            ...
            if (regex.test($('#txtEmailProf').val().trim())) {
                ...
                mensajesalertify("Email no es Valido..!", "W", "top-right", 5);
                return;
            }
        }
        ...
        if(_enviarprof == 'SI'){
            if(_emailprof.trim() == ''){
                mensajesalertify("Ingrese Email..!", "W", "top-right", 5);
            }
        }
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.trim() == 'OK'){
                    mensajesalertify("Profesional agregado correctamente..!", "S", "top-center", 5);
                    $("#modal-new-profesional").modal("hide");

                }else{
                    mensajesalertify("Profesional ya Existe..!", "W", "top-right", 5);
                }
            },								
            error: function (error){
                console.log(error);
