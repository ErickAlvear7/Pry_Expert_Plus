...
<?php
    ...
    $xSQL .= "WHERE men.menu_id=mta.menu_id AND mta.meta_id=pmt.meta_id AND pmt.pais_id=$xPaisid AND mta.tare_id=tar.tare_id "; 
    $xSQL .= "AND men.empr_id=$xEmprid AND men.menu_estado='A' AND tar.tare_estado='A' ";
    $xSQL .= "AND mta.meta_id NOT IN (SELECT pmt.meta_id FROM `expert_perfil_menu_tarea` pmt WHERE pmt.perf_id=$idperfil AND pmt.pais_id=$xPaisid AND pmt.meta_estado='A' AND pmt.empr_id=$xEmprid) ";
    ...
    $xSQL .= "FROM `expert_menu` men, `expert_menu_tarea` mta, `expert_perfil_menu_tarea` pmt, `expert_tarea` tar ";
    $xSQL .= "WHERE men.menu_id=mta.menu_id AND mta.meta_id=pmt.meta_id AND pmt.perf_id=$idperfil AND pmt.pais_id=$xPaisid AND mta.tare_id=tar.tare_id ";
...
?>	
        ...
        <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card">
                            <div class="card-header border-0 pt-6">
                                ...
                                <div class="card-toolbar">
                                    <button type="button" id="btnGuardar" class="btn btn-light-primary" onclick="f_Guardar(<?php echo $xPaisid; ?>,<?php echo $xEmprid; ?>,<?php echo $idperfil; ?>,<?php echo $xUsuaid; ?>)"><i class="las la-save"></i>Grabar</button>
                                </div>
                            </div>
            ...
            <script>
                ...
                function f_Guardar(_paisid, _emprid, _idperfil, _usuaid){
