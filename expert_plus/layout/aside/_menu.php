					...
					<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
						...
						<?php
							if($xPerfilName == 'Super Administrador' and $xPerfilid == 1 ) { ?>
								...
								<div data-kt-menu-trigger="click" class="menu-item <?php if($menuid == '1'){echo 'here show';} ?> menu-accordion mb-1">
									<span class="menu-link">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title">Configuracion Master</span>
										<span class="menu-arrow"></span>
									</span>
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link <?php if($page == 'param_sistema' || $page == 'editsuperparametro' ){echo 'active';} ?>" href="?page=param_sistema&menuid=1">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Parametros del Sistema</span>
											</a>
										</div>																																		
									</div>
								</div>
						...
						<div class="menu-item">
							<div class="menu-content pt-8 pb-2">
								<span class="menu-section text-muted text-uppercase fs-8 ls-1">ODONTOLOGICO</span>
							</div>
						</div>
