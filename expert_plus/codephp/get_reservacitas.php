<?php
    ...
    if(isset($_POST['xxPaisid']) and isset($_POST['xxEmprid']) and isset($_POST['xxPresid']) and isset($_POST['xxEspeid']) and isset($_POST['xxPfesid']) ){
        if(isset($_POST['xxPaisid']) <> '' and isset($_POST['xxEmprid']) <> '' and isset($_POST['xxPresid']) <> '' and isset($_POST['xxEspeid']) <> '' and isset($_POST['xxPfesid']) <> '' ){ 
            ...
            $xSQL = "SELECT rsrv_id as id,'RESERVADO' AS title,'Horario Reservado Temporalmente' AS description,fecha_inicio AS start,fecha_fin AS end,fecha_inicio,fecha_fin,codigo_dia,dia,usuariocreacion,  ";
