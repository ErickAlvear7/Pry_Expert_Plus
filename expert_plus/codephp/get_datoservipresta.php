<?php
    ...
    if(isset($_POST['xxPrseid']) and isset($_POST['xxPaisid']) and isset($_POST['xxEmprid']) and isset($_POST['xxPresid']) and isset($_POST['xxAsisid']) ){
        if(isset($_POST['xxPrseid']) <> '' and isset($_POST['xxPaisid']) <> '' and isset($_POST['xxEmprid']) <> '' and isset($_POST['xxPresid']) <> '' and isset($_POST['xxAsisid']) <> '' ){ 
        	...
        	$xSQL .= "`expert_tipo_asistencia`WHERE asis_id=$xAsisid) AS Asistencia FROM `expert_prestadora_servicio` prs WHERE prs.prse_id=$xPrseid AND ";
            $xSQL .="prs.pais_id=$xPaisid AND prs.empr_id=$xEmprid AND prs.pres_id=$xPresid";
